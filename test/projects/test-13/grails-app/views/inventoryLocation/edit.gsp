                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: inventoryLocationInstance, field: 'name', 'errors')}">
                                    <g:textField name="name" maxlength="50" value="${inventoryLocationInstance?.name}" />
                                </td>
                            </tr>
...
<g:link controller="inventoryItem" action="create" params="['inventoryLocation.id': inventoryLocationInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'inventoryItem.label', default: 'InventoryItem')])}</g:link>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="isActive"><g:message code="inventoryLocation.isActive.label" default="Is Active" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: inventoryLocationInstance, field: 'isActive', 'errors')}">
                                    <g:checkBox name="isActive" value="${inventoryLocationInstance?.isActive}" />
                                </td>
                            </tr>
