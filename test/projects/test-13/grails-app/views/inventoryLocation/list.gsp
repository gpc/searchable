                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="isActive" title="${message(code: 'inventoryLocation.isActive.label', default: 'Is Active')}" />
                    ...
                    <g:each in="${inventoryLocationInstanceList}" status="i" var="inventoryLocationInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td><g:formatBoolean boolean="${inventoryLocationInstance.isActive}" /></td>
