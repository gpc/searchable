            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="inventoryLocation.id.label" default="Id" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="inventoryLocation.inventoryItems.label" default="Inventory Items" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="inventoryLocation.name.label" default="Name" /></td>
